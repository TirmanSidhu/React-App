...
class Skills extends React.Component {
  ...
  constructor(props) {
    ...
    this.onMouseLeave = this.handleNoHover.bind(this);

    this.state={
      opinion:"Opinion Generator"
    };
  }
  ...
  handleHover(opinion) {
    ...
    if (counter < 140) {
      ...
      this.setState({
        opinion: "You hovered over these for more than 150 times, damn"
      });
    }
    else if (counter < 170) {
       this.setState({
        opinion: "You must really like this, thanks!!"
      });
    }
    else {
      this.setState({
        opinion: "Alright, Enough is Enough!"
      });
    }
  }
  handleNoHover(event) {
